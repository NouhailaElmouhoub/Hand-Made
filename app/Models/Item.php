...
class Item extends Model
{
    ...
    public function bol()
    {
        return $this->belongsTo(Bols::class, 'bol_id');
    }
    ...
    public function assiete()
    {
        return $this->belongsTo(Assietes::class, 'assiete_id');
    }
    
    public function getAssiete()
    {
        return $this->assiete;
    }

    public function setAssiete($assiete)
    {
